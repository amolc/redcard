...
#container .left .related ul li img{ width:210px;}
  ...
  <div class="left">
      ...
      <div id="social_3">
        <a href="http://www.facebook.com/share.php?u=<?php echo urlencode(get_permalink( $article->ID));?>"  title="Share on Facebook" ><div class="facebook" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=400');return false;"></div></a>

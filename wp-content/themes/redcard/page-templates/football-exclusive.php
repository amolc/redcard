<?php
/**
 * Template Name: Football Exclusive template Page
 
 */
get_header(); 
	$m_table=$wpdb->prefix."adverts";
	$advertQuery="select * from $m_table where page='football-exclusive' and isactive='1' order by adId DESC LIMIT 0,1";
...
<div class="left">
  <h2>Football > Exclusive</h2>
  <?php 
		$ad =1; 
		$terms = get_terms( 'footballexclusive', array(
    'orderby'    => 'count',
    'hide_empty' => 0
) );

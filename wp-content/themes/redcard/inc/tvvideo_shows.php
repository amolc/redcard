...
function tv_shows_init() {
	$labels = array(
		...
		'edit_item'          => __( 'Edit TV Schedule', 'your-plugin-textdomain' ),
		'view_item'          => __( 'View TV Schedule', 'your-plugin-textdomain' ),
		'all_items'          => __( 'All TV Schedules', 'your-plugin-textdomain' ),
		'search_items'       => __( 'Search TV Schedules', 'your-plugin-textdomain' ),
		'parent_item_colon'  => __( 'Parent TV Schedule :', 'your-plugin-textdomain' ),
		'not_found'          => __( 'No TV Schedule found.', 'your-plugin-textdomain' ),
		'not_found_in_trash' => __( 'No TV Schedules found in Trash.', 'your-plugin-textdomain' )
	);
	...
	$args = array(
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite'            => array( 'slug' => 'tv-schedule' ),

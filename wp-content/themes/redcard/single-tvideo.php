...
#container .left .related ul li img {
	width: 210px;
}
</style>
<div class="left">
...
$m_table=$wpdb->prefix."adverts";
  ...
  <?php $postID = get_the_ID();
		...
		$term_list_tag = wp_get_post_terms($postID, 'tvcategory');
		$as =1;
  ...
  )</a></span> <span class="bywriter" style="margin-left: 20px;">
  ...
  <div class="date">
    ...
    <?php $is++; ?>
    <?php } } ?>
    <div id="social_3"> <a onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=400');return false;" href="http://www.facebook.com/share.php?u=<?php echo get_permalink( $article->ID);?>"  title="Share on Facebook" >
      <div class="facebook" ></div>
      </a> <a href="http://twitter.com/intent/tweet?text=<?php echo the_title().' '.get_permalink( $article->ID);?> via @RedCardConnect&url=" target="_blank" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=400');return false;">
      <div class="twitter"></div>
      </a> <a href="#dis_comments">
  ...
  <div class="tags"> <strong>Tags:</strong>
    ...
    <?php $is++; ?>
    <?php } } ?>
    <span><a href="#dis_comment">Comments</a></span> </div>
  ...
  <div class="related related-radio">
    <ul>
      ...
      <li>
        <?php  echo $feat_image;?>
        <a href="<?php echo get_permalink( $row['ID']); ?>"><?php echo $row['post_title']; ?></a> </li>
      <?php } } ?>
    </ul>
  </div>

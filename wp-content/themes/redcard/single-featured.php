...
<div id="container">
  ...
  <div class="left">
   ...
   <div class="sigle-football-title"  style="margin-bottom: 13px;">
    ...
    <?php
		  $youtubtagline_value = get_post_meta( $postID, '_cmb_featured_tagline_text', true );  ?>
	...
	?>
    							...
    							<?php } else { ?>
    									...
    									<?php } ?>
                                <?php $is++; ?>
                                <?php } } */ ?>	<span><a href="#dis_comment">Comments</a></span> 
                                <div style="clear:both;"></div>
    
    <div class="author-bio" style="margin-top: 20px;">

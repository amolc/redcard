...
<div id="menu">
  <div class="menu_center">
	...
	<button type="submit" class="search-submit" style="width:30px;background: none repeat scroll 0 0 black;border: medium none;" ><i class="fa fa-search" style="color: #fff;"></i></button>
</form>
      </li>
    </ul>
  </div>

...
<div class="box">
  <div class="left">
    ...
    <ul class="bxslider">
	  ...
	  ?>
      <li><img src="<?php echo $feat_image; ?>" height="350" width="621" title="<label> <?php echo get_the_title( $row->post_id ); ?> </label><div><span class='facebook'></span> <a href='http://twitter.com/intent/tweet?text=&url=<?php echo get_permalink( $row->post_id);?>via @RedCardConnect'  ><span class='twitter'></span></a><span class='message'></span>1,200 views</div>" /></li>
    <?php } }?>

...
Donate Link: 
Tags: Double Opt-in Manager, newsletter, newsletters, newsletter plugin for WordPress, double opt-in newsletter plugin, double optin, wp newsletter plugin
...
This is the last version of the plugin. G-Lock Double Opt-In Manager is discontinued and will not be updated anymore. It's replaced with G-Lock WPNewsman plugin that can be downloaded at this page [WPNewsman.com](http://wpnewsman.com/ "WPNewsman.com").
...
Complatible with G-Lock EasyMail 6 [The Best Newletter Software](http://www.glocksoft.com/easymail/ "The Best Newletter Software for Windows 8") :

* [Download in-house newletter software free trial](http://www.glocksoft.com/download-products/ "in-house newsletter software download")
...
= 2.6.4 =
* Fixed: Variables not working in "already-confirmed" Action template
* Fixed: Blog Broadcast Settings: Loading Stuck 
* the plugin uses PHPMailer class from the WordPress core now

= 2.6.3 =
* Highly recommended security release. 
...
= 2.6.1 =
Contains several important fixes and improvements. Intermediate highly recommended update before the major upgrade release.
...
http://www.glockeasymail.com/newsletter-plugin-wordpress/